...
describe("WorktreeList", () => {
  ...
  it("renders project cluster headers when groupByProject is on", () => {
    const mkLinear = (ticket: string, project: string) => ({
      identifier: ticket,
      title: `Ticket ${ticket}`,
      state: { id: "s1", name: "In Progress", type: "started" as const },
      project: { id: `p-${project}`, name: project },
    });
    const wt1 = makeWorktree({ id: "wt-1", branch: "feature/a", linear_info: mkLinear("ENG-1", "Alpha") });
    const wt2 = makeWorktree({ id: "wt-2", branch: "feature/b", linear_info: mkLinear("ENG-2", "Alpha") });
    const wt3 = makeWorktree({ id: "wt-3", branch: "feature/c", linear_info: mkLinear("BUG-9", "Beta") });
    const group: WorktreeGroup = { repo: makeRepo(), worktrees: [wt1, wt2, wt3] };
  ...
  it("does not render project headers when groupByProject is off", () => {
    const linearInfo = {
      identifier: "ENG-1",
      title: "Task",
      state: { id: "s1", name: "In Progress", type: "started" as const },
    ...
    const group: WorktreeGroup = { repo: makeRepo(), worktrees: [wt1] };
